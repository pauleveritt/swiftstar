...
**P25: DeepSeek V4 Flash — moved up (2026-08-27):** the flagship rung is wanted now; implementation is in progress (offline cycles 1–3, 4a are safe unattended; 4b wants review; cycle 5 live run skipped by decision; cycle 6 SSD deferred). See the P25 row and its design doc.
