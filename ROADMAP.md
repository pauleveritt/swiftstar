...
progress and P26 is complete (2026-08-29). **Updated 2026-08-30:** P24 is started — **P24.1 (window-honoring reads) closed and merged**, after review overturned its original read-guard framing; P24.2 (read-guard re-decision + pool `readCache`) and the instrument-reconciliation cleanup cycle remain. See the P24 row. Power pacing stays in the Backlog until
