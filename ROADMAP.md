...
**P20 is closing first (2026-08-27):** ship the `/orchestrate` coordination loop (model-driven, one-shot-first) and the dispatch-preference bootstrap rule (prompt-only); descope small-ctx workers (→ its own phase, merged with P23) and two-phase `/spike` (→ Backlog behind P24) — see the P20 row.

**P18 is next:** build `mellum-fixture` — a small, one-shot benchmark. Not another
repair loop.**
