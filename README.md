...
weights, shows you what your machine is doing while the model runs, gives you a
chat and an agent — and tells you *why* your session got slow, from
measurement rather than folklore.

It does no inference itself. Inference is delegated to `ds4-server` and
`ds4-agent`, child processes built from a fork of
[antirez/ds4](https://github.com/antirez/ds4) carried as a submodule.
